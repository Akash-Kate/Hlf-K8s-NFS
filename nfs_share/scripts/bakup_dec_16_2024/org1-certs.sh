...
echo "Generate the peer 2 MSP"
fabric-ca-client enroll -u https://peer2:peer2pw@ca-org1:7054 --caname ca-org1 -M "/organizations/peerOrganizations/org1.example.com/peers/peer2.org1.example.com/msp" --csr.hosts peer2.org1.example.com --csr.hosts  peer2-org1 --tls.certfiles "/organizations/fabric-ca/org1/tls-cert.pem"
...
fabric-ca-client enroll -u https://peer3:peer3pw@ca-org1:7054 --caname ca-org1 -M "/organizations/peerOrganizations/org1.example.com/peers/peer3.org1.example.com/msp" --csr.hosts peer3.org1.example.com --csr.hosts  peer3-org1 --tls.certfiles "/organizations/fabric-ca/org1/tls-cert.pem"
